...
<section id="finishBook" class="d-flex flex-column gap-4 align-items-center pt-4 px-3">
...
<div class="w-100 d-flex align-items-center justify-content-center flex-shrink-0 card p-3">
<img src="{{ Storage::url($transaction->product->thumbnail) }}" alt="Thumbnail" class="img-fluid object-fit-contain rounded-3" style="max-height: 300px;" />
</div>
...
<p id="bookingId" class="fw-semibold fs-5 mb-0">{{ $transaction->trx_id }}</p>
<button class="btn btn-sm btn-outline-secondary rounded-pill" onclick="copyBookingId()">
