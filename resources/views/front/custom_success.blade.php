...
@section('content')
    <main class="main-content-container py-4 text-center">
        <section id="SuccessOrder" class="d-flex flex-column gap-4 align-items-center pt-4 px-3"> {{-- Added px-3 --}}
            ...
            <div class="d-flex flex-column gap-2 align-items-center">
                ...
                <div class="d-flex align-items-center gap-3 justify-content-center"> {{-- Centered content --}}
                    <p id="orderId" class="fs-5 fw-bold text-body mb-0">{{ $transaction->trx_id }}</p> {{-- Added ID for copying --}} {{-- Added text-white class for dark mode visibility --}}
