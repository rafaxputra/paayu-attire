...
<input type="hidden" name="transaction_id" value="{{ $rentalTransaction->trx_id }}">
        ...
        <section id="Product-name" class="mb-3 card p-3">
        ...
        <hr class="mx-3 my-3" />
        <div id="Customer-info" class="d-flex flex-column gap-3 card p-3">
        ...
        <hr class="mx-3 my-3">
        <div id="Send-Payment" class="d-flex flex-column gap-3 card p-3">
        ...
        <hr class="mx-3 my-3">
        <div id="Confirm-Payment" class="d-flex flex-column gap-3 card p-3">
        ...
        <button type="submit" class="btn btn-primary rounded-pill px-4 py-2 fw-bold w-100">Checkout</button>
    </form>
</main>
@endsection
