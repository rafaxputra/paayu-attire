...
<section id="CheckBook" class="d-flex flex-column gap-4 align-items-center pt-4 px-3">
...
<p class="text-muted text-center mb-0">Masukkan details berikut untuk melihat status pemesanan Anda saat ini</p>
        ...
        <form action="{{ route('front.transactions.details') }}" method="GET"
            ...
            <div class="d-flex flex-column gap-2">
                <label for="phone" class="form-label fw-semibold mb-0 d-flex align-items-center gap-2"><i class="bi bi-telephone"></i> Phone Number</label>
            ...
            <div class="d-flex flex-column gap-2">
                <label for="bookId" class="form-label fw-semibold mb-0 d-flex align-items-center gap-2"><i class="bi bi-card-heading"></i> Book ID</label>
                <div class="input-group">
                    <span class="input-group-text">
            ...
            <button type="submit" class="btn btn-primary rounded-pill px-4 py-2 fw-bold w-100 d-flex align-items-center justify-content-center gap-2"><i class="bi bi-search"></i> Check My Booking</button>
        </form>
    </section>
