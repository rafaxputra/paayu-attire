...
<h2 class="h5 mb-3 fw-semibold d-flex align-items-center gap-2"><i class="bi bi-box-seam"></i> Product</h2>
...
<div id="Bottom-nav" class="fixed-bottom bg-white border-top">
    <div class="container main-content-container">
        <div class="d-flex items-center justify-content-between p-3 relative z-10">
            ...
            <button type="submit" form="booking-form" class="btn btn-primary rounded-pill px-4 py-2 fw-bold">Checkout</button>
        </div>
    </div>
</div>
@endsection
